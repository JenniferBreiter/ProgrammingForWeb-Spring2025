    ...
    <div>
      ...
      <form onSubmit={handleSubmit(getFormData)}>
        ...
        <fieldset>
          ...
          <div className="form-group">
            <label htmlFor="" className="required">What do you like about Alpacas?</label>
            <textarea rows="8" cols="50" {...register("alpacaEssay", {required: true})}></textarea>
            {errors.alpacaEssay ? (<p className='error'>Required</p>): <></>}
          </div>
        </fieldset>
